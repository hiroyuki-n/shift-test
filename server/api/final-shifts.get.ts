...
export default defineEventHandler(async (event) => {
  ...
  let query = client
    .from('final_shifts')
    .select('id, date, startTime, endTime, positionId, userId, shopId, hourlywage, users!final_shifts_userId_fkey(name, employmentType, primaryShopId), shops(name), shop_positions(name)')
